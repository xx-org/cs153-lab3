...
80100ba2:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
 cprintf("Initial number of pages by the process: %d\n", curproc->stackPages); //cs153 - Lab3 
80100ba9:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80100bb0:	00 
80100bb1:	c7 04 24 f0 6e 10 80 	movl   $0x80106ef0,(%esp)
80100bb8:	e8 93 fa ff ff       	call   80100650 <cprintf>
  for(argc = 0; argv[argc]; argc++) {
80100bbd:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bc0:	8b 00                	mov    (%eax),%eax
80100bc2:	85 c0                	test   %eax,%eax
80100bc4:	0f 84 63 01 00 00    	je     80100d2d <exec+0x38d>
80100bca:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bcd:	31 d2                	xor    %edx,%edx
80100bcf:	8d 71 04             	lea    0x4(%ecx),%esi
80100bd2:	89 cf                	mov    %ecx,%edi
80100bd4:	89 d1                	mov    %edx,%ecx
80100bd6:	89 f2                	mov    %esi,%edx
80100bd8:	89 fe                	mov    %edi,%esi
80100bda:	89 cf                	mov    %ecx,%edi
80100bdc:	eb 0a                	jmp    80100be8 <exec+0x248>
80100bde:	66 90                	xchg   %ax,%ax
80100be0:	83 c2 04             	add    $0x4,%edx
    if(argc >= MAXARG)
80100be3:	83 ff 20             	cmp    $0x20,%edi
80100be6:	74 81                	je     80100b69 <exec+0x1c9>
...
80100c21:	e8 1a 61 00 00       	call   80106d40 <copyout>
80100c26:	85 c0                	test   %eax,%eax
80100c28:	0f 88 3b ff ff ff    	js     80100b69 <exec+0x1c9>
  for(argc = 0; argv[argc]; argc++) {
...
80100c8e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c94:	e8 a7 60 00 00       	call   80106d40 <copyout>
80100c99:	85 c0                	test   %eax,%eax
80100c9b:	0f 88 c8 fe ff ff    	js     80100b69 <exec+0x1c9>
  for(last=s=path; *s; s++)
...
80100d01:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
80100d04:	89 57 08             	mov    %edx,0x8(%edi)
  curproc->tf->eip = elf.entry;  // main
80100d07:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d0d:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d10:	8b 47 1c             	mov    0x1c(%edi),%eax
80100d13:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d16:	89 3c 24             	mov    %edi,(%esp)
80100d19:	e8 42 59 00 00       	call   80106660 <switchuvm>
  freevm(oldpgdir);
80100d1e:	89 34 24             	mov    %esi,(%esp)
80100d21:	e8 ba 5c 00 00       	call   801069e0 <freevm>
  return 0;
...
80103898:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
8010389a:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
8010389d:	89 5a 18             	mov    %ebx,0x18(%edx)
  *np->tf = *curproc->tf;
...
801038a7:	8b 43 04             	mov    0x4(%ebx),%eax
801038aa:	89 42 04             	mov    %eax,0x4(%edx)
  np->sz = curproc->sz;
801038ad:	8b 03                	mov    (%ebx),%eax
801038af:	89 02                	mov    %eax,(%edx)
  np->tf->eax = 0;
801038b1:	8b 42 1c             	mov    0x1c(%edx),%eax
801038b4:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038bb:	90                   	nop
...
8010393b:	eb f1                	jmp    8010392e <fork+0xde>
    kfree(np->kstack);
8010393d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103940:	8b 43 0c             	mov    0xc(%ebx),%eax
80103943:	89 04 24             	mov    %eax,(%esp)
80103946:	e8 a5 e9 ff ff       	call   801022f0 <kfree>
    return -1;
8010394b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    np->kstack = 0;
80103950:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    np->state = UNUSED;
80103957:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
...
801044d6:	3d fa ff ff 7f       	cmp    $0x7ffffffa,%eax
...
801044fa:	e8 a1 f1 ff ff       	call   801036a0 <myproc>
  ...
  if(addr >= STACKTOP || addr+4 >= STACKTOP)
801044ff:	81 fb fa ff ff 7f    	cmp    $0x7ffffffa,%ebx
80104505:	77 25                	ja     8010452c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104507:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010450a:	89 da                	mov    %ebx,%edx
8010450c:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010450e:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80104510:	39 c3                	cmp    %eax,%ebx
80104512:	73 18                	jae    8010452c <fetchstr+0x3c>
    if(*s == 0)
80104514:	80 3b 00             	cmpb   $0x0,(%ebx)
80104517:	75 0c                	jne    80104525 <fetchstr+0x35>
80104519:	eb 1d                	jmp    80104538 <fetchstr+0x48>
8010451b:	90                   	nop
...
80104564:	8d 44 90 04          	lea    0x4(%eax,%edx,4),%eax
  if(addr >= STACKTOP || addr+4 >= STACKTOP)
80104568:	3d fa ff ff 7f       	cmp    $0x7ffffffa,%eax
...
80105574:	e8 27 e1 ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105579:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010557c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105580:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105583:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105586:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010558a:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
8010558e:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            myproc()->pid, myproc()->name, tf->trapno,
80105591:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105594:	89 54 24 18          	mov    %edx,0x18(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105598:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010559c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
...
80105658:	bf ff ff ff 7f       	mov    $0x7fffffff,%edi
8010565d:	89 fa                	mov    %edi,%edx
8010565f:	8b 40 04             	mov    0x4(%eax),%eax
80105662:	c1 e0 0c             	shl    $0xc,%eax
80105665:	29 c2                	sub    %eax,%edx
80105667:	39 f2                	cmp    %esi,%edx
80105669:	0f 86 51 ff ff ff    	jbe    801055c0 <trap+0xb0>
	if(allocuvm(myproc()->pgdir, STACKTOP-(myproc()->stackPages+1)*PGSIZE, STACKTOP-myproc()->stackPages*PGSIZE)==0){
8010566f:	e8 2c e0 ff ff       	call   801036a0 <myproc>
80105674:	89 fb                	mov    %edi,%ebx
80105676:	8b 40 04             	mov    0x4(%eax),%eax
80105679:	c1 e0 0c             	shl    $0xc,%eax
8010567c:	29 c3                	sub    %eax,%ebx
8010567e:	e8 1d e0 ff ff       	call   801036a0 <myproc>
80105683:	8b 40 04             	mov    0x4(%eax),%eax
80105686:	83 c0 01             	add    $0x1,%eax
80105689:	c1 e0 0c             	shl    $0xc,%eax
8010568c:	29 c7                	sub    %eax,%edi
8010568e:	e8 0d e0 ff ff       	call   801036a0 <myproc>
80105693:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80105697:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010569b:	8b 40 08             	mov    0x8(%eax),%eax
8010569e:	89 04 24             	mov    %eax,(%esp)
801056a1:	e8 1a 12 00 00       	call   801068c0 <allocuvm>
801056a6:	85 c0                	test   %eax,%eax
801056a8:	75 1d                	jne    801056c7 <trap+0x1b7>
		cprintf("case T_PGFLT from trap.c: allocuvm failed. Number of current allocated pages: %d\n", myproc()->stackPages);
801056aa:	e8 f1 df ff ff       	call   801036a0 <myproc>
801056af:	8b 40 04             	mov    0x4(%eax),%eax
801056b2:	c7 04 24 50 76 10 80 	movl   $0x80107650,(%esp)
801056b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801056bd:	e8 8e af ff ff       	call   80100650 <cprintf>
	 exit();
801056c2:	e8 d9 e3 ff ff       	call   80103aa0 <exit>
	myproc()->stackPages += 1;
801056c7:	e8 d4 df ff ff       	call   801036a0 <myproc>
801056cc:	83 40 04 01          	addl   $0x1,0x4(%eax)
...
801056d8:	c7 04 24 a4 76 10 80 	movl   $0x801076a4,(%esp)
801056df:	89 44 24 04          	mov    %eax,0x4(%esp)
801056e3:	e8 68 af ff ff       	call   80100650 <cprintf>
	return; 	
801056e8:	e9 24 ff ff ff       	jmp    80105611 <trap+0x101>
801056ed:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801056f0:	e8 8b df ff ff       	call   80103680 <cpuid>
801056f5:	85 c0                	test   %eax,%eax
801056f7:	0f 84 b3 00 00 00    	je     801057b0 <trap+0x2a0>
801056fd:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105700:	e8 7b d0 ff ff       	call   80102780 <lapiceoi>
    break;
80105705:	e9 b6 fe ff ff       	jmp    801055c0 <trap+0xb0>
8010570a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
80105710:	e8 bb ce ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
...
80105720:	e8 1b 02 00 00       	call   80105940 <uartintr>
    lapiceoi();
80105725:	e8 56 d0 ff ff       	call   80102780 <lapiceoi>
    break;
...
80105737:	e8 44 df ff ff       	call   80103680 <cpuid>
8010573c:	c7 04 24 2c 76 10 80 	movl   $0x8010762c,(%esp)
...
8010574f:	e8 fc ae ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105754:	e8 27 d0 ff ff       	call   80102780 <lapiceoi>
    break;
80105759:	e9 62 fe ff ff       	jmp    801055c0 <trap+0xb0>
8010575e:	66 90                	xchg   %ax,%ax
    ideintr();
80105760:	e8 1b c9 ff ff       	call   80102080 <ideintr>
...
8010579f:	5d                   	pop    %ebp
      exit();
801057a0:	e9 fb e2 ff ff       	jmp    80103aa0 <exit>
801057a5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
801057a8:	e8 f3 e2 ff ff       	call   80103aa0 <exit>
801057ad:	eb cd                	jmp    8010577c <trap+0x26c>
801057af:	90                   	nop
      acquire(&tickslock);
801057b0:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057b7:	e8 84 e9 ff ff       	call   80104140 <acquire>
      wakeup(&ticks);
801057bc:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
801057c3:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
801057ca:	e8 c1 e5 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
801057cf:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057d6:	e8 55 ea ff ff       	call   80104230 <release>
801057db:	e9 1d ff ff ff       	jmp    801056fd <trap+0x1ed>
801057e0:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057e3:	8b 73 38             	mov    0x38(%ebx),%esi
801057e6:	e8 95 de ff ff       	call   80103680 <cpuid>
...
801057fa:	c7 04 24 f4 76 10 80 	movl   $0x801076f4,(%esp)
80105801:	89 44 24 04          	mov    %eax,0x4(%esp)
80105805:	e8 46 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010580a:	c7 04 24 26 76 10 80 	movl   $0x80107626,(%esp)
...
8010670d:	8b 56 0c             	mov    0xc(%esi),%edx
...
8010672a:	8b 46 08             	mov    0x8(%esi),%eax
...
80106b53:	0f 84 7a 01 00 00    	je     80106cd3 <copyuvm+0x193>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106bc7:	0f 84 19 01 00 00    	je     80106ce6 <copyuvm+0x1a6>
    if(!(*pte & PTE_P))
80106bcd:	8b 30                	mov    (%eax),%esi
80106bcf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bd5:	0f 84 ff 00 00 00    	je     80106cda <copyuvm+0x19a>
    pa = PTE_ADDR(*pte);
...
80106c0f:	c3                   	ret    
  for(i = 0; i < sz; i += PGSIZE){
80106c10:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106c15:	e9 94 00 00 00       	jmp    80106cae <copyuvm+0x16e>
...
80106c27:	e8 a4 f7 ff ff       	call   801063d0 <walkpgdir>
80106c2c:	85 c0                	test   %eax,%eax
80106c2e:	0f 84 b2 00 00 00    	je     80106ce6 <copyuvm+0x1a6>
    if(!(*pte & PTE_P))
80106c34:	8b 30                	mov    (%eax),%esi
80106c36:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c3c:	0f 84 98 00 00 00    	je     80106cda <copyuvm+0x19a>
    pa = PTE_ADDR(*pte);
80106c42:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c44:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c4a:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c4d:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c53:	e8 48 b8 ff ff       	call   801024a0 <kalloc>
80106c58:	85 c0                	test   %eax,%eax
80106c5a:	89 c6                	mov    %eax,%esi
80106c5c:	74 9d                	je     80106bfb <copyuvm+0xbb>
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106c5e:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106c64:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c6b:	00 
80106c6c:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106c70:	89 04 24             	mov    %eax,(%esp)
80106c73:	e8 a8 d6 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106c78:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c7b:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c81:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c85:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c8c:	00 
80106c8d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c91:	89 44 24 10          	mov    %eax,0x10(%esp)
...
80106cb8:	8b 40 04             	mov    0x4(%eax),%eax
...
80106cd5:	e9 2e ff ff ff       	jmp    80106c08 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106cda:	c7 04 24 22 79 10 80 	movl   $0x80107922,(%esp)
80106ce1:	e8 7a 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ce6:	c7 04 24 08 79 10 80 	movl   $0x80107908,(%esp)
